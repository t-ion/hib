    ...
    Movie Cruiser</div>
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavbar">  
            <ul class="navbar-nav active">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="color: white;" href="showfavorite"><i class="material-icons" id="iconsize">favorite</i> Favorite List</a>
                </li>
      ...
      <div class="jumbotron text-center topBack mbd">
              </div>
    <div class="container-fluid mbd conti">
        <div class="row">
