...
<body class="mbd">
    ...
    Movie Cruiser</div>
       ...
       <div class="collapse navbar-collapse" id="collapsibleNavbar">  
            <ul class="navbar-nav active">
                <li class="nav-item">
                    <a class="nav-link" href="showPage"><i class="fas fa-tape" id="iconsize"></i> Movie List</a>
                </li>
    ...
    <div class="title1"> <i class="material-icons badge-danger">favorite_border</i>   Favorites</div>
   
    <div class="container-fluid conti mbd">
        <div class="row">
